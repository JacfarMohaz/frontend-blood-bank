...
function Footer() {
  ...
  const handleLinkClick = (section) => {
    ...
    return <div>
        ...
        <div className="sm:flex justify-between sm:px-40 mt-8 sm:mt-20 pb-5">
            ...
            <div className="pt-20 pl-10 sm:pl-0">
                ...
                <p className="text-seconderyColor text-xl pb-2 flex"><div className="mt-3 bg-primeryColor w-9 h-9 rounded-full"><i class="fa-solid text-fourthColor pl-2 pt-2 fa-headset"></i></div><span className="pl-3 pt-3">+252618704206</span></p>
