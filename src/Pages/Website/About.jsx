import LogoPNG from "../../assets/som blood bank logo.png"



function About() {
    return <div id="about" className="max-w[1400px] mx-auto w-full sm:h-[54em] h-[90em] bg-thirdColor sm:mt-40 mt-60 py-20">
        ...
        <div className="sm:flex px-5 sm:px-0 justify-center items-center gap-20 pt-10">
            ...
            <h1 className="text-xl text-primeryColor font-bold sm:pt-8 pt-20 text-center sm:text-start sm:leading-10 ">SOM Blood Bank Management System is a software application <br />
        ...
        <div className="sm:flex justify-center pt-28">
            <div className="bg-seconderyColor max-w[1400px] hover:bg-primeryColor cursor-pointer mx-auto  sm:w-[28em] w-[24em] sm:h-48 h-62 sm:mb-0 mb-20 rounded-lg">
                ...
                <p className="text-textColor px-12 py-5 leading-normal">To efficiently manage the supply and distribution <br />
